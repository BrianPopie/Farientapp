    ...
    <Card className="glass-panel border-white/5 bg-gradient-to-br from-white/5 to-transparent">
      <CardContent className="flex flex-col gap-4 p-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-muted-foreground">{citationCount} citations</span>
        </div>
        <Button variant="ghost" className="justify-start gap-2 px-0 text-sm text-primary" type="button">
          View provenance
