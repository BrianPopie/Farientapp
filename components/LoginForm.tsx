...
export function LoginForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="mt-6 grid gap-4 text-foreground dark:text-white">
      <div className="grid gap-2">
        <Label id={emailLabelId} htmlFor={emailId} className="text-foreground/80 dark:text-white/90">
          Email
        </Label>
        <Input
          id={emailId}
          ...
          className="border-border bg-card text-foreground caret-foreground placeholder:text-muted-foreground focus-visible:ring-ring dark:border-white/30 dark:bg-white/10 dark:text-white dark:caret-white dark:placeholder:text-white/60"
        />
      </div>
      <div className="grid gap-2">
        <Label id={passwordLabelId} htmlFor={passwordId} className="text-foreground/80 dark:text-white/90">
          Password
        </Label>
        <Input
          id={passwordId}
      ...
      <Button
        type="submit"
        disabled={loading}
        className="mt-1 bg-primary/80 text-primary-foreground shadow-[0_10px_30px_rgba(0,0,0,0.25)] hover:bg-primary dark:bg-white/20 dark:text-white"
      >
        {loading ? "Signing in..." : "Sign in"}
      </Button>
      <div className="pb-2 text-center text-xs text-muted-foreground dark:text-white/70">
