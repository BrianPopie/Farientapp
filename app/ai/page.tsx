          ...
          <main className="container space-y-8 py-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 max-w-3xl">
                Capture the five inputs once, run the band engine via server actions, and keep the role-aware chat in sync
                with your selections for workflows, evidence, and hand-offs.
              </p>
            </div>
